...
class TodoChipItem extends StatelessWidget {
  ...
  TodoChipItem(this.todo,{this.color=Colors.blue,this.onTap,this.onDelete});
  ...
  Widget build(BuildContext context) {
   ...
   var color= todo.todoDone==0?this.color:Colors.green;
    ...
    var tile=ListTile(//布局主体
      leading: Container(child:ClipOval(child: Text("${todo.todoId}",style: titleTextStyle)),//左边
        padding: EdgeInsets.all(10),
        decoration: BoxDecoration(
          shape: BoxShape.circle, //圆形装饰线
          color: Colors.blue,
          boxShadow: [BoxShadow(color:color.withAlpha(55),
      ...
      trailing: InkWell(child: Icon(Icons.close),onTap: (){
        onDelete(todo);
      },),//尾部
    );
