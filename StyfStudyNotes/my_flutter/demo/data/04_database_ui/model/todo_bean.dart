...
class TodoBean {
  ...
  double get progress=>Convert.progressBetweenTime(todoStartTime,todoEndTime,todoCreateTime);
  TodoType get type => Convert.date2Type(todoStartTime,todoEndTime,todoCreateTime,done);
