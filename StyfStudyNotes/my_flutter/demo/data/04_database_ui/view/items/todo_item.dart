...
class TodoItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var right = Column(
      children: <Widget>[
        Text("开始时间："+todo.startDate, style: infoStyle,),
        pH(12),
        Text("结束时间："+todo.endDate, style: infoStyle,),
      ],
    );
    ...
    return   Stack(
            ...
            children:<Widget>[itemTodo, Padding(
              padding: const EdgeInsets.only(top:1.0),
              child: CornerShape(color: todo.color,text: stateMap[todo.type],height: 15,),
            )]
    );
  }
