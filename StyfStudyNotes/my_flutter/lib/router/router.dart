...
class YFRouter {
  static Map<String, FlutterBoostRouteFactory> routerMap = {
    MainPage.routeName: (settings, uniqueId) {
      return PageRouteBuilder(pageBuilder: (ctx, a1, a2) {
        return MainPage();
      });
    },
    ...
    CategoryPage.routeName: (settings, uniqueId) {
      return Right2LeftRouter(child: CategoryPage());
    },
    MessagePage.routeName: (settings, uniqueId) =>
        PageRouteBuilder(pageBuilder: (_, __, ___) => MessagePage()),
    MyPage.routeName: (settings, uniqueId) =>
        PageRouteBuilder(pageBuilder: (_, __, ___) => MyPage()),
    UnknowPage.routeName: (settings, uniqueId) =>
        PageRouteBuilder(pageBuilder: (_, __, ___) => UnknowPage())
  };
